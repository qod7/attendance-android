...
public class NepaliCalendar {
    ...
    public static NepaliDate convertGregorianToNepaliDate(final Calendar gregorianCalendar) throws NepaliDateException {
        return convertGregorianToNepaliDate(gregorianCalendar.getTime());
    }
     ...
     */
    public static NepaliDate convertGregorianToNepaliDate(final Date gregorianDate) throws NepaliDateException {
     ...
     *
     * @param nepaliDate the nepali date
     * @return the gregorian date
     */
    public static Date convertNepaliToGregorianDate(final NepaliDate nepaliDate) {
     ...
     *
     * @param nepaliYearNumberPart1 the year of the start of the fiscal year. So "2067" of
     *                              "2067/2068"
     * @param fiscalYearType        the fiscal year type
     ...
     *
     * @param nepaliYearNumberPart2 the year of the end of the fiscal year. So "2068" of
     *                              "2067/2068"
     * @param fiscalYearType        the fiscal year type
     ...
     *
     * @param date                  the date object of the specific date
     * @param nepaliYearNumberPart2 the year of the end of the fiscal year. So "2068" of
     *                              "2067/2068"
     * @param fiscalYearType        the fiscal year type
